...
def main():
    ...
    recurTest = filecmp.cmp('testing.txt', 'expected_outputs/recurTest.txt')
    if recurTest:
    ...
    print("Testing behaviour...")
    dynamicTest = filecmp.cmp('testing.csv', 'expected_outputs/dynamicTest.csv')
    if dynamicTest:
    ...
    # Cleanup - commented out to keep the files for debugging
    for file in [
        "testing.csv",
        "testing.txt",
